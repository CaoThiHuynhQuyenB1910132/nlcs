                                ...
                                <div class="col-sm-6 col-lg-4 mb-4 aos-init aos-animate" data-aos="fade-up">
                                    <div class="block-4 text-center border">
                                        <figure class="block-4-image">
                                            <a href="{{ route('productDetail', ['id' => $sanpham->id]) }}">
                                                <img src="{{ $sanpham->hinh_anh }}" alt="Image placeholder"
                                                    class="img-fluid"></a>
                                        </figure>
                                        <div class="block-4-text p-4">
                                            <h3><a href="{{ route('productDetail', ['id' => $sanpham->id]) }}">{{ $sanpham->ten_sp }}</a>
                                            </h3>
                                            <p class="mb-0">{{ $sanpham->mo_ta }}</p>
                                            <p class="text-primary font-weight-bold">{{ $sanpham->gia }} VNĐ</p>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                        @else
                            <div class="col-sm-6 col-lg-4 mb-4 aos-init aos-animate" data-aos="fade-up">Không có kết quả nào
                            </div>
                        @endif
